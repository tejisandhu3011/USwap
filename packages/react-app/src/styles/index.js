const styles = {
  // App.js
  container: "flex justify-center min-h-screen sm:px-16 px-6 bg-site",
  innerContainer:
    "flex justify-between items-center flex-col max-w-[1280px] w-full blue-glassmorphism",
  ...
  headTitle: "text-3xl sm:text-6xl text-white text-gradient py-5",
  subTitle: "text-2xl sm:text-3xl text-white text-gradient py-5",
  ...
  footerLink:
    "bg-site-blue border-none outline-none px-6 py-2 font-poppins font-bold text-lg text-white rounded-3xl leading-[24px] hover:bg-pink-600 transition-all",
  // AmountIn & AmountOut
  amountContainer:
